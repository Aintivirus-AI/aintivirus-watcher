/**
 * Local heuristic analysis, shared by the Express server and the Cloudflare
 * Worker. Pure TypeScript over the submitted probe data — no Node APIs — which
 * is what lets one implementation serve both runtimes.
 */

export interface UserDataForAnalysis {
  hardware: {
    gpu: string | null;
...
export function generateLocalAnalysis(data: UserDataForAnalysis): AIAnalysisResponse['analysis'] {
